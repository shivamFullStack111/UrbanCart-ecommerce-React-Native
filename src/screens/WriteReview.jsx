  ...
  return (
    <View style={{ flex: 1, backgroundColor: "white" }}>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        >
          <Text style={{ color: gray.most, fontSize: 22 }}>Overall Rating</Text>
          <Text style={{ color: gray.gray, fontSize: 16 }}>
            Your Average Rating is 5.0
          </Text>
          <View style={{ flexDirection: "row", gap: 5, marginTop: 10 }}>
            <FontAwesomeIcon icon={faStar} size={34} color="gold" />
            <FontAwesomeIcon icon={faStar} size={34} color="gold" />
            <FontAwesomeIcon icon={faStar} size={34} color="gold" />
            <FontAwesomeIcon icon={faStar} size={34} color="gold" />
            <FontAwesomeIcon icon={faStar} size={34} color="gold" />
        ...
        <View style={{ width: "95%", alignSelf: "center", marginTop: 20 }}>
          <Text style={{ color: gray.most, fontSize: 18 }}>Product Review</Text>
          <TextInput
            style={{
              backgroundColor: gray.extraLight,
              flex: 1,
        ...
        <View style={{ padding: 10 }}>
          ...
          >
            Would you recommend this product to a friends?
          </Text>
          <View
            style={{
              flexDirection: "row",
      ...
      <TouchableOpacity style={{ padding: 10, bottom: 40 }}>
