...
const TrackOrder = () => {
  ...
  return (
    <ScrollView contentContainerStyle={{flexGrow: 1, backgroundColor: 'white',    marginTop:30}}>
      ...
      <View
        ...
        <View style={{flex: 1, gap: 4}}>
          <Text style={{color: gray.dim, fontSize: 17, fontWeight: '500'}}>
          ...
          <Text style={{color: 'green', fontWeight: '500'}}>DELIVERY</Text>
      ...
      <MainHeading2 heading={'Track Order'} />
      ...
      <View style={{padding: 10, flexDirection: 'row', gap: 10}}>
        <View style={{alignItems: 'center'}}>
          ...
          <View style={{height: 60, backgroundColor: 'red', width: 3}}></View>
          <View
            style={{
              width: 30,
              height: 30,
        ...
        <View style={{gap: 45.5}}>
          <View>
            <Text style={{color: 'red', fontSize: 17, fontWeight: '600'}}>
              Order Placed{' '}
              <Text style={{fontSize: 15, color: gray.dim}}>27 Dec 2023</Text>
            </Text>
            <Text style={{color: gray.gray}}> We have received your order</Text>
          </View>
          <View>
            <Text style={{color: 'red', fontSize: 17, fontWeight: '600'}}>
              Order Confirm{' '}
            ...
            <Text style={{color: gray.gray}}> We has been confirmed</Text>
          </View>
          <View>
            <Text style={{color: 'red', fontSize: 17, fontWeight: '600'}}>
              Order Processed{' '}
            ...
            <Text style={{color: gray.gray}}> We are preparing your order</Text>
          </View>
          <View>
            <Text style={{color: 'red', fontSize: 17, fontWeight: '600'}}>
              Ready To Ship{' '}
